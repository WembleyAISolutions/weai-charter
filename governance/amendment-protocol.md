...
A major Charter amendment requires all of the following artifacts:
...
A major amendment is adopted only when all of the following occur:

1. Amendment proposal is opened as a PR.
2. Proposal includes all required sections.
3. Structural diff is included.
4. Sovereignty compliance verification is included.
5. Boundary impact review is included.
6. Lower-layer impact review is included.
7. Review is completed.
8. Final decision is recorded.
9. New versioned Charter file is merged, if the amendment changes Charter text.
10. The merged PR clearly states that the amendment is adopted.

No single chat message, model output, local file, draft, or unmerged branch can adopt a Charter amendment.
